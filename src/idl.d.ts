 ...
 */
export declare class IntClass extends PrimitiveType<BigNumber> {
    accept<D, R>(v: Visitor<D, R>, d: D): R;
    covariant(x: any): x is BigNumber;
    encodeValue(x: BigNumber | number): Buffer;
    encodeType(): Buffer;
    decodeValue(b: Pipe): BigNumber;
    get name(): string;
    valueToString(x: BigNumber): string;
}
/**
 * Represents an IDL Nat
 */
export declare class NatClass extends PrimitiveType<BigNumber> {
    accept<D, R>(v: Visitor<D, R>, d: D): R;
    covariant(x: any): x is BigNumber;
    encodeValue(x: BigNumber | number): Buffer;
    encodeType(): Buffer;
 ...
 */
export declare class FixedIntClass extends PrimitiveType<BigNumber | number> {
    private _bits;
    ...
    encodeValue(x: BigNumber | number): Buffer;
    encodeType(): Buffer;
    decodeValue(b: Pipe): number | BigNumber;
    get name(): string;
    valueToString(x: BigNumber | number): string;
}
/**
 * Represents an IDL fixed-width Nat(n)
 */
export declare class FixedNatClass extends PrimitiveType<BigNumber | number> {
    private _bits;
    constructor(_bits: number);
    accept<D, R>(v: Visitor<D, R>, d: D): R;
    covariant(x: any): x is BigNumber;
...
export declare class RecordClass extends ConstructType<Record<string, any>> {
    ...
    decodeValue(b: Pipe): Record<string, any>;
    get name(): string;
    display(): string;
 ...
 */
declare class TupleClass<T extends any[]> extends RecordClass {
 ...
 */
export declare function encode(argTypes: Array<Type<any>>, args: any[]): Buffer;
/**
